...
library JackRampDeploymentLib {
    ...
    function deployContracts(
        ...
        result.jackRampServiceManager = UpgradeableProxyLib.setUpEmptyProxy(proxyAdmin);
        ...
        bytes memory upgradeCall = abi.encodeCall(
            ECDSAStakeRegistry.initialize, (result.jackRampServiceManager, 0, quorum)
        );
        UpgradeableProxyLib.upgradeAndCall(result.stakeRegistry, stakeRegistryImpl, upgradeCall);
        UpgradeableProxyLib.upgrade(result.jackRampServiceManager, jackRampServiceManagerImpl);
    ...
    function readDeploymentJson(
        ...
        data.jackRampServiceManager = json.readAddress(".contracts.jackRampServiceManager");
    ...
    function writeDeploymentJson(
        ...
        address proxyAdmin = address(UpgradeableProxyLib.getProxyAdmin(data.jackRampServiceManager));
